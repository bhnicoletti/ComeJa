...
/**
 * <p>ListaPessoaEmpresaBean class.</p>
 *
 * @author Nicoletti
 * @version $Id: $Id
 */
@ManagedBean
@ViewScoped
public class ListaPessoaEmpresaBean implements Serializable {  
    ...
    /**
     * <p>Constructor for ListaPessoaEmpresaBean.</p>
     */
    public ListaPessoaEmpresaBean() {
        model = new LazyDataModel<Pessoa>() {
            ...
            public List<Pessoa> load(int first, int pageSize,
                ...
                setRowCount(pDAO.quantidadeFiltradosADM(filtro));
                RequestContext.getCurrentInstance().execute("estilo();");
                return pDAO.filtradosADM(filtro);
