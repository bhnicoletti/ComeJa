...
@ManagedBean
@ViewScoped
public class ListaProdutoEmpresaBean implements Serializable {  
    ...
    public ListaProdutoEmpresaBean() {
        model = new LazyDataModel<Produto>() {
            ...
            public List<Produto> load(int first, int pageSize,
                ...
                setRowCount(prodDAO.quantidadeFiltradosEmpresa(filtro));
                RequestContext.getCurrentInstance().execute("estilo();");
                return prodDAO.filtradosEmpresa(filtro);
