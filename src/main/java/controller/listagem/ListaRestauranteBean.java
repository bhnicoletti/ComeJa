...
/**
 * <p>ListaRestauranteBean class.</p>
 *
 * @author Nicoletti
 * @version $Id: $Id
 */
@ManagedBean
@ViewScoped
public class ListaRestauranteBean implements Serializable {  
    ...
    /**
     * <p>Constructor for ListaRestauranteBean.</p>
     */
    public ListaRestauranteBean() {
        model = new LazyDataModel<Pessoa>() {
            ...
            public List<Pessoa> load(int first, int pageSize,
                ...
                filtro.setCategoria("Restaurante");
