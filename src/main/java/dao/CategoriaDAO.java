...
public class CategoriaDAO {
     ...
     */
    public String cadastrar(Categoria c) {
    ...
    private Criteria criarCriteriaParaFiltro(Filtro filtro) {
        try {
            ...
            if (StringUtils.nonEmptyString(filtro.getDescricao())) {
                criteria.add(Restrictions.ilike("tituloCategoria", filtro.getDescricao(), MatchMode.ANYWHERE));
            }
     ...
     * <p>carregar.</p>
     *
     * @param i a {@link java.lang.Long} object.
     * @return a {@link model.Categoria} object.
     */
    public Categoria carregar(Long i) {
        Categoria c = null;
        try {
            sessao = HibernateUtil.getSession();
            c = (Categoria) sessao.load(Categoria.class, i);
            return c;
        } catch (Exception ex) {
